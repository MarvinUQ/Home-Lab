...
## White-Box-Testing: This conflicts, bugs and solutions are part of a larning method in which I had access to the entire process from pentesting to SOC analysis, this gives a best vantage point of view of everything happening during an attack, yet it defeats the purpose of a pentest, if the attacker can't access he should find another tools or techniques and not wait for the IT staff to grant him access to the organization. To have a better understanding of how each role works closer to real life I will change the focus to a Black-Box-Testing approach that will help me on learning by testing and working each role focused on their respective tools, techniques and thought process.

## ES: Estos conflictos, errores y soluciones son parte de un método de practica en el cual tengo completo acceso al proceso de forma completa, desde el test de penetración hasta el análisis de los registros y data, esto da una mayor perspectiva de lo que pasa durante un ataque pero al mismo tiempo contradice el propósito de un test de penetración donde el atacante si no puede acceder mediante una herramienta debe buscar otras maneras con esa o con otras herramientas, en lugar de esperar que el soporte técnico de la organización atacada le abra las puertas para que el pueda atacar. Para tener una mejor compresión de como cada rol trabaja en la vida real voy a cambiar por la metodología Black-Box-Testing, cuyo forma de funcionar me va ayudar a aprender mediante probar y practicar cada rol enfocado en sus respectivas herramientas, técnicas y procesos de pensamiento.
